...
class MainScreen(MDScreen):
    ...
    def open_camera_for_recognition(self):
        # Remove a mensagem (Opcional) - a câmera sobrescreve esse widget
        for widget in self.children[:]:  # cópia da lista para evitar erros ao remover
        ...
        if self.cap.isOpened():
            ...
            # Chama a função para carregar o vídeo a cada frame (~60 FPS)
