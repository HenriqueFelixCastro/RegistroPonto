...
class Command(BaseCommand):
    ...
    def reconhecer_faces(self):
        ...
        while True:
            ...
            faces_detectadas = face_cascade.detectMultiScale(imagemCinza, minNeighbors=5)
            ...
            for (x, y, l, a) in faces_detectadas:
                ...
                try:
                    ...
                    if funcionario:
                        cv2.putText(frame_redimensionado, str(funcionario.nome).strip(), (x, y + (a + 30)), font, 1, (255, 255, 0), 1)
                except Funcionario.DoesNotExist:
                    cv2.putText(frame_redimensionado, "Nenhum user encontrado", (x, y + (a + 30)), font, 1, (255, 0, 0), 1)
