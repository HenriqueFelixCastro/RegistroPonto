...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            model_filename = self.treinamento_face()
            if model_filename is None:
                self.stdout.write(self.style.ERROR("Nenhum modelo foi gerado."))
                return
    ...
    def treinamento_face(self):
        ...
        eigenFace = cv2.face.EigenFaceRecognizer_create(num_components=50, threshold=5000.0)
        ...
        # Cria arquivo temporário de forma multiplataforma
